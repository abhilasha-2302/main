          ...
          <div className="w-full md:w-4/5 grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/subscriptions" className="text-gray-600 hover:text-green-600 text-sm">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/trademarks" className="text-gray-600 hover:text-green-600 text-sm">
                    Trademarks & Brands
                  </Link>
                </li>
                <li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-green-600">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
