      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-gray-50 rounded-lg p-8 text-center">
            ...
            <a href="mailto:support@veripointtech.com" className="text-green-600 hover:text-green-700 font-medium">
          ...
          <div className="bg-gray-50 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-4">Instant help from our support team</p>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="border rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Product Support</h3>
              <p className="text-gray-600 text-sm">Get help with SDCVP-X™ and other products</p>
            </div>
            ...
            <div className="border rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm">Solutions for technical issues and integration</p>
            </div>
            ...
            <div className="border rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm">Access guides, manuals, and tutorials</p>
            </div>
            ...
            <div className="border rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm">Manage your account and billing inquiries</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="border border-gray-200 rounded-lg">
              <button className="w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50">
                <span className="font-medium text-gray-900">What are the system requirements?</span>
                <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
            ...
            <div className="border border-gray-200 rounded-lg">
              <button className="w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50">
                <span className="font-medium text-gray-900">What support options are available?</span>
                <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
